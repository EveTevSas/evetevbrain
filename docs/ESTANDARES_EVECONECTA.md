...
*Estándares de la vertical **EveConecta** (`apps/eve-conecta`): gestión y recaudo para conjuntos residenciales en propiedad horizontal. Es la primera vertical de **EvePay**, la plataforma de pagos de **Evetev SAS**.*
