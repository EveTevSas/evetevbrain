...
const SECCIONES = [
  ...
  },
  {
    label: "SISTEMA",
    items: [
      { href: "/config",       texto: "Configuración", Ico: IcoConfig },
    ],
  },
];
    ...
    <aside style={{
      ...
      <div style={{ padding: "1.25rem 1rem 1rem", borderBottom: "1px solid #EDF3FA" }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "0.5rem", textDecoration: "none" }}>
          ...
          <div>
            <div style={{ fontFamily: "var(--font-brand)", fontWeight: 700, fontSize: "1rem", color: "#0A2540", lineHeight: 1.2 }}>
              EveLedger
            </div>
            <div style={{ fontSize: "0.62rem", fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "#94A3B8" }}>
              por Evetev
            </div>
          </div>
        </Link>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ margin: 0, fontSize: "0.78rem", fontWeight: 600, color: "#0A2540", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
            Administrador
          </p>
          {email && (
        ...
        <form action={logout}>
          <button type="submit" title="Cerrar sesión" style={{
            ...
            padding: 6, color: "#64748B", borderRadius: 6, flexShrink: 0,
