...
function Row({ label, value, mono }: { label: string; value: React.ReactNode; mono?: boolean }) {
  return (
    <div style={{
      ...
      padding: "0.875rem 0", borderBottom: "1px solid var(--eve-linea)"
    }}>
      <span style={{
  ...
  return (
    <div>
      <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
        <Link href="/transacciones" style={{
          color: "var(--eve-electrico)", textDecoration: "none", fontSize: "0.875rem"
        }}>
          ← Transacciones
        </Link>
      ...
      {loading && (
        <div className="card" style={{ textAlign: "center", padding: "3rem", color: "var(--eve-pizarra)" }}>
          Cargando...
        </div>
      )}
            ...
            {cobro.checkoutUrl && (
              <Row label="Link de pago" value={
                <a
                  ...
                  style={{ color: "var(--eve-electrico)", textDecoration: "none", fontSize: "0.8rem" }}
                >
                  Abrir link →
                </a>
              } />
