...
function MetricCard({
  ...
  return (
    <div
      className="card"
      style={{ flex: 1, minWidth: 180, display: "flex", flexDirection: "column", gap: "0.75rem" }}
    >
      ...
      <div>
        ...
        {sub && (
          <p style={{ margin: "0.25rem 0 0", fontSize: "0.78rem", color: "var(--eve-pizarra)" }}>
            {sub}
          </p>
        )}
      </div>
...
export default function DashboardPage() {
  ...
  const aprobRate =
    stats && stats.total > 0 ? Math.round((stats.aprobados / stats.total) * 100) : 0;
