    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
        <div style={{ width: "100%", maxWidth: 380 }}>
          ...
          <div
            className="card"
            style={{ background: "#fff", boxShadow: "0 4px 24px rgba(10,37,64,.10)" }}
          >
            <h1 style={{ marginBottom: "0.25rem", fontSize: "1.25rem" }}>Iniciar sesión</h1>
            <p
              style={{ marginBottom: "1.5rem", color: "var(--eve-pizarra)", fontSize: "0.875rem" }}
            >
