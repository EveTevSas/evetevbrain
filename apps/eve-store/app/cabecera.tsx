import { CuentaCarrito } from "@/app/cuenta-carrito";
 ...
 * navegador; la pinta `CuentaCarrito`, el único trozo de esta cabecera que se
 * ejecuta en el cliente. El carrito de verdad sigue siendo `carrito`, httpOnly, y sigue
      ...
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-4 gap-y-3 px-6 py-3">
        ...
        {!minima && (
          <>
            ...
            <a
              href="/carrito"
              className="order-2 ml-auto shrink-0 rounded-lg border border-linea px-3 py-2 text-sm font-medium hover:bg-hielo sm:order-3 sm:ml-0"
            >
              Carrito
              <CuentaCarrito />
            </a>
